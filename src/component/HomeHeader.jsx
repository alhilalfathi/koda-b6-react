...
export const HomeHeader = () => {
  return (
    <div className="flex">
        <main className="w-1/2 h-auto bg-zinc-950">
            <div className="text-white px-30 py-40">
                <h1 className="font-bold text-5xl mb-10">Start Your Day with Coffee and Good Meals</h1>
