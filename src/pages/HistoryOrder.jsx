...
const ProductDiv = () => {
    return(
        <div className="flex gap-5 my-5 bg-[#E8E8E8] p-3">
            <img src="src/assets/img/image31.png" alt="product image" className="w-24 h-24" />
            <div className="flex flex-col justify-top items-center">
                <span className="flex gap-3 justify-center items-center">
                    <img src="src/assets/img/order.png"/> No. Order
                </span>
            ...
            <div className="flex flex-col justify-top items-center">
                <span className="flex gap-3 justify-center items-center">
                    <img src="src/assets/img/Calendar.png"/> Date
                </span>
                <p className="font-bold">23 January 2023</p>
            </div>
            <div className="flex flex-col justify-top items-center">
                <span className="flex gap-3 justify-center items-center">
                    <img src="src/assets/img/Repeat.png"/> Total
                </span>
        ...
        <div>
            ...
            <div className="flex gap-5 mx-20">
                ...
                <aside className="w-[40%] border border-[#E8E8E8] h-full p-5">
                    <img src="src/assets/img/message.png" alt="message icon"/>
