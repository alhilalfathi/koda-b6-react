            ...
            <div className="mr-15">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={filterButton} className="bg-orange-500 text-white mt-6 px-4 py-2 rounded-lg flex items-center gap-2 cursor-pointer">
                ...
                <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y">
                            {loading ? (
                                <tr>
                                    <td colSpan="9" className="text-center p-5">Loading...</td>
                                </tr>
                            ) : currentProducts.length === 0 ? (
                                <tr>
                                    <td colSpan="9" className="text-center p-5">No Product Found</td>
                                </tr>
                            ) : (
                                currentProducts.map(product => (
                                    <tr key={product.id}>
                                        ...
                                        <td className="p-4">
                                            <img src={product.img} className="w-12 h-12 rounded object-cover" />
                                        </td>
                                        <td className="p-4">{product.name}</td>
                                        <td className="p-4">IDR {product.price?.toLocaleString()}</td>
                                        <td className="p-4 text-gray-500">{product.tag}</td>
                                        <td className="p-4">R, M, L</td>
                    ...
                    <div className="flex justify-between items-center p-4 text-sm text-gray-500">
                        <span>
                            Show {currentProducts.length} product of {filteredProducts.length} product
                        </span>
