    ...
    <div className="py-10 relative">
        ...
        <div className="absolute top-0 right-0 w-271 bg-black/40 min-h-screen hidden">
            <div className="absolute top-0 right-0 w-100 min-h-screen border p-5 bg-white">
                ...
                <InputDiv type={"text"} id={"phone"} name={"phone"} icon={<CiPhone />} placeholder={"Enter Your Number"}>Phone</InputDiv>
                <InputDiv type={"password"} id={"password"} name={"password"} icon={<GoKey />} placeholder={"Enter Your Password"} eye={<FiEye />}>Password</InputDiv>
                <InputDiv type={"text"} id={"address"} name={"address"} icon={<GoLocation />} placeholder={"Enter Your Address"}>Address</InputDiv>
